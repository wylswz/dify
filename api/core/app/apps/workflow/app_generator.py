...
from core.helper.trace_id_helper import extract_external_trace_id_from_args, extract_tool_node_span_id_from_args
    ...
    def generate(
        ...
        *,
        ...
        extras = {
            ...
            **extract_tool_node_span_id_from_args(args),
        }
