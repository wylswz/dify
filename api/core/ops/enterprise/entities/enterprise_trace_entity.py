"""Data entities for Enterprise OTLP tracing."""
...
class SpanData(BaseModel):
    """Data model for span information in Enterprise OTLP trace system."""

    model_config = {"arbitrary_types_allowed": True}

    trace_id: int = Field(..., description="The unique identifier for the trace (128-bit).")
    parent_span_id: int | None = Field(None, description="The ID of the parent span, if any.")
    span_id: int = Field(..., description="The unique identifier for this span (64-bit).")
